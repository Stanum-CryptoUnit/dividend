...
public:
    ...
    {}
    [[eosio::action]] void distribute(uint64_t id, time_point_sec slice_at, eosio::asset quantity);
    [[eosio::action]] void pay(uint64_t distribution_id, eosio::name pay_to, eosio::asset quantity);
    [[eosio::action]] void cancel(uint64_t distribution_id);
    ...
    static constexpr eosio::name _findir = "cfo"_n;
    static constexpr eosio::name _payer = "payer"_n;
    
    static constexpr eosio::name _token_contract = "eosio.token"_n;
    static constexpr eosio::symbol _op_symbol     = eosio::symbol(eosio::symbol_code("USDU"), 4);
